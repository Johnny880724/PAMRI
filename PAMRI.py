...
with open("ACE_data/ACE_2018.txt", "r") as file:
...
#     print("B0", B0_peaks, B0_probs)
    ...
    ax_B0.plot(time_arr,B0_arr)
    ax_B0.plot(time_arr,B0_filter)
    ax_B0.plot(time_arr[B0_peaks],B0_filter[B0_peaks],".",markersize=10,label="peaks")
    ...
    ax_Bz.plot(time_arr,Bz_arr)
    ax_Bz.plot(time_arr,Bz_filter)
    ax_Bz.plot(time_arr[Bp_peaks],Bz_filter[Bp_peaks],"g.",markersize=10,label="+ peaks")
    ax_Bz.plot(time_arr[Bm_peaks],Bz_filter[Bm_peaks],"r.",markersize=10,label="- peaks")
    ...
    for i, peak_all in enumerate(peaks_all):
        ...
        ax_sp.plot(time_arr,prob_spect)
